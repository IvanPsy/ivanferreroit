...
title: "Scrivi troppo bene: come i criteri anti-AI stanno colpendo gli studenti neurodivergenti"
date: 2026-07-28
speciale: true
stream: speciale
categories: [speciale]
slug: "scrivi-troppo-bene"
icon: "★"
autore: Ivan Ferrero
...
>
> [Apri il reperto: Tre colonne →](/dashboards/tre-colonne.html)
...
- **Non far mai diventare un sospetto un voto senza dirlo.** Se il dubbio incide sulla valutazione, va nominato ad alta voce e per intero all'interessato. Un sospetto che si trasforma silenziosamente in un cinque è la forma peggiore, perché non lascia nulla a cui rispondere.
- **Tieni separata la valutazione del testo dal giudizio sull'autore.** Sono due atti diversi. Il secondo, se proprio deve avvenire, non può travestirsi da primo.
- **Chiedi del processo, non dell'autenticità.** «Raccontami come ci sei arrivato» è un atto didattico e funziona con chiunque. «L'hai scritto tu?» è un procedimento indiziario mascherato da domanda.
- **Non fondare mai un giudizio su marcatori stilistici.** Nessuna delle liste che circolano è uno strumento validato, nessuna dichiara un tasso di errore, e le caratteristiche che elencano sono in larga parte le stesse che prescriviamo agli studenti con bisogni educativi speciali.
- **Dubita in una forma a cui l'altro possa rispondere.** Un dubbio che non si può confutare non è un dubbio, è una condanna con un altro nome.
- **Se lo studente ha una certificazione o un piano, il dubbio non resta in una testa sola.** Va portato nel consiglio di classe, dove siedono le persone che hanno i dati relazionali e la storia del percorso. È esattamente a questo che serve avere un docente di sostegno in quella stanza.
- **Considera che il salto di qualità potrebbe essere il tuo lavoro che funziona.** Prima di leggerlo come indizio, controlla se per caso è l'obiettivo scritto nel piano di quel ragazzo.
...
- Chambers, S., Kelley, M. C. (2026). *The misclassification of autistic writing as AI-generated*. arXiv:2607.14729. Versione editoriale: [doi.org/10.1007/978-3-031-98420-4_7](https://doi.org/10.1007/978-3-031-98420-4_7)
...
- Chaka, C. (2024). *Accuracy pecking order: how 30 AI detectors stack up*. Journal of Applied Learning and Teaching, 7(1).
- Gegg-Harrison, W., Quarterman, C. (2024). *AI Detection's High False Positive Rates and the Psychological and Material Impacts on Students*. In: Academic Integrity in the Age of Artificial Intelligence, IGI Global.
- Brown, L. X. Z. (2020). *How Automated Test Proctoring Software Discriminates Against Disabled Students*. Center for Democracy and Technology.
- Crompton, C. J., Ropar, D., Evans-Williams, C. V., Flynn, E. G., Fletcher-Watson, S. (2020). *Autistic peer-to-peer information transfer is highly effective*. Autism, 24(7).
- Monk, R., Whitehouse, A. J. O., Waddington, H. (2022). *The use of language in autism research*. Trends in Neurosciences, 45(11).
- Volden, J., Lord, C. (1991). *Neologisms and idiosyncratic language in autistic speakers*. Journal of Autism and Developmental Disorders, 21(2).
- Dwyer, M., Laird, E. (2024). *Up in the Air: Educators Juggling the Potential of Generative AI with Detection, Discipline, and Distrust*. Center for Democracy and Technology.
...
- Milani, L. e Scuola di Barbiana (1967). *Lettera a una professoressa*. Libreria Editrice Fiorentina.
- Bernstein, B. (1971). *Class, Codes and Control*. Routledge.
- Legge 170/2010 e Linee guida allegate al DM 5669/2011, per gli strumenti compensativi e le misure dispensative. DM 153/2023 per il modello nazionale di PEI.
- Le guide in lingua italiana su come riconoscere un testo generato dall'intelligenza artificiale, generaliste e rivolte agli insegnanti, sono state consultate fra il 2023 e il 2026 e sono liberamente reperibili in rete. Le voci citate in questo articolo sono raccolte e confrontate nel reperto [Tre colonne](/dashboards/tre-colonne.html).
